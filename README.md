<h1 align="center">
  🎨 Zebra de Touca<br>
  <sub>Catálogo Digital & Calculadora de Orçamentos</sub>
</h1>

<p align="center">
  <img src="https://img.shields.io/badge/UNIVESP-Projeto%20Integrador%20II-blue?style=for-the-badge" alt="UNIVESP PI II">
  <img src="https://img.shields.io/badge/PHP-8%2B-777BB4?style=for-the-badge&logo=php&logoColor=white" alt="PHP 8+">
  <img src="https://img.shields.io/badge/Slim%20Framework-4-8BC34A?style=for-the-badge" alt="Slim 4">
  <img src="https://img.shields.io/badge/MySQL-MariaDB-4479A1?style=for-the-badge&logo=mysql&logoColor=white" alt="MySQL">
  <img src="https://img.shields.io/badge/PHPUnit-10-3C9CD7?style=for-the-badge" alt="PHPUnit 10">
  <img src="https://img.shields.io/badge/License-Educacional-lightgrey?style=for-the-badge" alt="Licença">
</p>

<p align="center">
  <i>Sistema web full-stack desenvolvido sob medida para uma microempreendedora de papelaria personalizada.</i>
</p>
...
- [🎯 O Problema Real da Empreendedora](#-o-problema-real-da-empreendedora)
- [💡 A Solução Desenvolvida](#-a-solução-desenvolvida)
- [🚀 Requisitos da UNIVESP Atendidos](#-requisitos-da-univesp-atendidos)
- [🛠️ Tecnologias Utilizadas](#️-tecnologias-utilizadas)
- [🔌 Rotas da API REST](#-rotas-da-api-rest)
- [📂 Estrutura de Pastas do Projeto](#-estrutura-de-pastas-do-projeto)
- [💻 Como Rodar o Projeto Localmente](#-como-rodar-o-projeto-localmente)
- [📱 Fluxo de Uso do Cliente](#-fluxo-de-uso-do-cliente)
- [👥 Integrantes do Projeto](#-integrantes-do-projeto-univesp)
- [📄 Licença](#-licença)
...
Este projeto foi desenvolvido como parte do **Projeto Integrador II — UNIVESP**.
...
| ⚠️ Problema | 📉 Impacto |
| :--- | :--- |
| **Sobrecarga e Perda de Tempo** | A artesã precisava vasculhar manualmente fotos antigas na galeria do celular para apresentar seus trabalhos. |
...
1. **🗂️ Vitrine Categorizada ("Pastas Virtuais")** — Organização dos produtos por categorias temáticas (Topos de Bolo, Caixas Cenário, Lembrancinhas, Convites), facilitando a navegação e filtragem.
2. **🖼️ Página Detalhada do Produto** — Exibição de fotos reais, dimensões indicadas, descrição completa dos materiais e indicação de destaques (*Mais Vendidos*, *Lançamentos*).
3. **⚙️ API REST Interna** — Regras de negócio e cálculo de orçamento centralizados no backend com **Slim Framework 4**, garantindo segurança no valor final e evitando manipulação no frontend.
...
| Camada | Tecnologias |
| :--- | :--- |
| **Back-End** | ![PHP](https://img.shields.io/badge/PHP-8%2B-777BB4?style=flat-square&logo=php&logoColor=white) ![Slim](https://img.shields.io/badge/Slim-4-8BC34A?style=flat-square) ![Composer](https://img.shields.io/badge/Composer-885630?style=flat-square&logo=composer&logoColor=white) |
| **Testes** | ![PHPUnit](https://img.shields.io/badge/PHPUnit-10-3C9CD7?style=flat-square) |
...
| **Servidor Web** | ![Apache](https://img.shields.io/badge/Apache-D22128?style=flat-square&logo=apache&logoColor=white) ![LiteSpeed](https://img.shields.io/badge/LiteSpeed-3B4B8C?style=flat-square) |
...
**a)** Crie o banco de dados no seu MySQL importando o arquivo:

```bash
database/schema.sql
```

**b)** Copie o arquivo de exemplo de conexão e configure seus dados de acesso:
...
### 4️⃣ Execução dos Testes Automatizados
...
### 5️⃣ Executando o Servidor Local
...
| 👤 Integrante | 📍 Polo |
| :--- | :--- |
| Flávio Fernandes dos Santos | Américo Brasiliense |
| Andersom Leandro Gonçalez Frederigi | Brotas |
| Jessika Moretti | São Carlos |
| Regiane de Oliveira Gaspar | Araraquara |
| Erica Gonçalves | Matão |
| Jéssica Marina Goveia | São Carlos |
| Leonardo Coelho Sanchez | Brotas |
| Lucas Magno de Oliveira | Araraquara |
...
<p align="center">
  <i>Este projeto é desenvolvido para fins exclusivamente <b>educacionais e acadêmicos</b>.</i>
</p>

---

<p align="center">
  <b>UNIVESP</b> — Projeto Integrador II
</p>